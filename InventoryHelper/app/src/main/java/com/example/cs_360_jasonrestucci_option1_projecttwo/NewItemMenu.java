            ...
            public void onClick(View view) {
                try (SQLiteManager sqLiteManager = SQLiteManager.instanceOfDatabase(NewItemMenu.this)) {
                    if (editTextName != null && editTextQty != null && editTextCategory != null) {
                        item item = new item(editTextName.getText().toString().toUpperCase(), Integer.parseInt(editTextQty.getText().toString()), editTextCategory.getText().toString().toUpperCase(), editTextNotes.getText().toString().toUpperCase());
